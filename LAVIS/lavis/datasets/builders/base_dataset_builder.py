...
class BaseDatasetBuilder:
    ...
    def _download_ann(self):
        ...
        for split in splits:
            ...
            urls, storage_paths = info.get("url", None), '/fs/nexus-projects/brain_project/acl_sk_24/LAVIS/export/export'
...
class MultiModalDatasetBuilder(BaseDatasetBuilder):
    ...
    def _get_dataset_args(self, info, is_train):
        ...
        for modality in self.data_type:
            ...
            mm_path = '/fs/nexus-projects/brain_project/acl_sk_24/LAVIS/export'
